...
class Employee {
    constructor(role) {
        ...
        this.do = (staff, projectPrameters) => __awaiter(this, void 0, void 0, function* () {
            const premise = "Pretend you are planing a stratup with the main idea of: " +
...
_Employee_plan = new WeakMap();
const roleInfo = {
    ceo: {
        name: "Chief Executive Officer",
        description: "responsible for providing overall leadership, vision, and direction for the company. They make strategic decisions, manage resources, and represent the company to stakeholders such as investors, customers, and partners",
        deliverables: [
    ...
    cto: {
        ...
        description: "in charge of the company's technology strategy and development. They oversee the technological aspects of the product or service, lead the engineering team, and ensure that the technology infrastructure supports the company's goals",
        deliverables: [
    ...
    coo: {
        ...
        description: "responsible for the day-to-day operations of the company. They oversee functions such as finance, human resources, marketing, and sales, ensuring that processes run smoothly and efficiently",
        deliverables: [
    ...
    cfo: {
        ...
        description: "responsible for managing the company's finances and financial risks. They oversee financial planning, budgeting, fundraising, and financial reporting, ensuring that the company remains financially healthy and compliant with regulations",
        deliverables: [
    ...
    cmo: {
        ...
        description: "responsible for developing and executing the company's marketing strategy. They oversee marketing campaigns, branding, customer acquisition, and market research, working to increase awareness and drive sales",
        deliverables: [
    ...
    cso: {
        ...
        description: "responsible for developing and executing the company's overall strategy for growth and expansion. They analyze market trends, identify opportunities for innovation, and develop long-term strategic plans to achieve the company's objectives",
        deliverables: [
    ...
    cpo: {
        ...
        description: "responsible for the development and management of the company's products or services. They oversee product design, development, and delivery, working closely with the engineering and design teams to ensure that the product meets the needs of customers and aligns with the company's vision",
        deliverables: [
