...
class MealService extends app_types_1.AppObject {
    constructor(name, schema, value) {
        super(name, schema, value);
        this.calculateMacros = () => __awaiter(this, void 0, void 0, function* () { });
        this.calculateCalories = () => __awaiter(this, void 0, void 0, function* () { });
